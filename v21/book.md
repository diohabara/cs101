...
PIT は水晶発振子に基づく $1{,}193{,}182\,\text{Hz}$ のベースクロックを持ちます。除数を設定すると $1{,}193{,}182 \div \text{除数}$ Hz でタイマー割り込みが発生します。

設定例:

$$\text{周波数} = \frac{1{,}193{,}182}{11{,}932} \approx 100\,\text{Hz} \quad (\text{10ms ごと})$$
...
$100\,\text{Hz}$ で $50$ ティック $= 500\,\text{ms}$ 後に "50 ticks reached" が出力されます。
